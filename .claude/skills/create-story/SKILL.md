...
- Communicate in plain English prose and generate all documents in {document_output_language}
...
<step n="6" goal="Update sprint status and finalize">
  ...
  <output>**🎯 ULTIMATE STORY CONTEXT CREATED!**
    ...
    **Next Steps:**
    ...
    4. Optional: run `testarch-atdd` before `dev-story` for red-phase acceptance tests, and `testarch-trace` after `code-review` for coverage + gate decision
